...
class Formats {
  ...
  static const plainText = SimpleValueFormat<String>(
    ...
    ohos: SimplePlatformCodec(
      formats: ['general.plain-text'],
      onDecode: fromSystemUtf8,
    ),
    // other platforms
